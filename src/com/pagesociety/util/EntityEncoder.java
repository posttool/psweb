...
public class EntityEncoder
{
    ...
    public static String encode(String s)
    {
        ...
        for (int i=0; i<chars.length; i++) {
            sb.append(EntityEncoder.getEntity(chars[i]));
        }
        return sb.toString();
    }
    ...
    public static String encodeNumeric(String s)
    {
        ...
        char[] chars = s.toCharArray();
        for (int i=0; i<chars.length; i++) {
            sb.append(EntityEncoder.getNumericEntity(chars[i]));
        }
        return sb.toString();
    }
        ...
        return new FilterWriter(out) {
            ...
            throws IOException {
                for (int i=off; i<off+len; i++) {
                    this.out.write(EntityEncoder.getEntity(cbuf[i]));
                }
            }
            ...
            public void write(int c) throws IOException {
               this.out.write(EntityEncoder.getEntity((char)c));
            }
