 ...
 * NOTE:
 *
 * 04/27/2006 -- adopted to com.limelife.common package name
 *               for LimeLife by Mahmoud Parsian.
 */
...
public class RandomGUID extends Object {
     ...
     */
 	private static Logger theLogger = Logger.getLogger(RandomGUID.class);
    ...
    private void getRandomGUID(boolean secure) {
        ...
        try {
            ...
            theLogger.error("getRandomGUID Error: ", e);
        }
    ...
    public static void main(String args[]) {
		// 64A4DD34-78C2-FB3C-7075-5198CB9C7868
		// 64a4dd3478c2fb3c70755198cb9c7868
		long  start = System.currentTimeMillis();
        for (int i=0; i< 100; i++) {
            RandomGUID myGUID = new RandomGUID();
            theLogger.debug("main(): Seeding String=" + myGUID.valueBeforeMD5);
            theLogger.debug("main(): rawGUID=" + myGUID.valueAfterMD5);
            theLogger.debug("main(): RandomGUID=" + myGUID.toString());
        }
		long  end = System.currentTimeMillis();
    	long time = end - start;
		System.out.println("time="+time);

		String oneMoreGUID = RandomGUID.getGUID();
        theLogger.debug("main(): oneMoreGUID=" + oneMoreGUID);
    }
