...
public class RawUIModule extends WebModule
{
	...
	protected void FORM_RADIO_GROUP(UserApplicationContext uctx,String group_name,String[] names, String[] vals,String[] classes,String default_val,int size)
	{
		FORM_RADIO_GROUP(get_user_buf(uctx), group_name, names,vals,classes,default_val,size);
	}

	protected void FORM_RADIO_GROUP(StringBuilder buf,String group_name,String[] names, String values[],String[] classes,String default_val,int size)
	{
		for(int i = 0;i < names.length;i++)
		{
			...
			buf.append("<input class='"+clazz+"' id='"+group_name+"_"+val+"' type='radio' name='"+group_name+"' value='"+val+"' "+(default_val != null && default_val.equals(val)?"checked":"")+" ><label style='font-size:"+size+"px'>"+name+"</label>\n");
		}
	}
	...
	{
		buf.append("<TH align='left'>"+data+"</TH>\n");
	}
