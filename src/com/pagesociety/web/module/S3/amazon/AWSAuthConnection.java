...
package com.pagesociety.web.module.S3.amazon;
...
public class AWSAuthConnection {
     ...
     * @throws IOException
     */
    protected HttpURLConnection makeRequest(String method, String bucketName, String key, Map pathArgs, Map headers)
        throws MalformedURLException, IOException
    {
     ...
     */
    public HttpURLConnection makeRequest(String method, String bucket, String key, Map pathArgs, Map headers,
                                          S3Object object)
        throws MalformedURLException, IOException
    {
