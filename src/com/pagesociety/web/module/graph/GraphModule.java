...
public class GraphModule extends WebStoreModule 
{
	...
	protected void defineIndexes(Map<String,Object> config) throws PersistenceException,InitializationException
	{
		...
		(
			GRAPH_ENTITY,
			ENTITY_INDEX(IDX_GRAPH_BY_CREATOR_BY_GRAPH_NAME , EntityIndex.TYPE_SIMPLE_MULTI_FIELD_INDEX, FIELD_CREATOR,GRAPH_FIELD_NAME)
		);		
		DEFINE_ENTITY_INDICES
		(
			GRAPH_VERTEX_ENTITY,
			ENTITY_INDEX(IDX_GRAPH_VERTEX_BY_GRAPH_BY_VERTICE_CLASS , EntityIndex.TYPE_SIMPLE_MULTI_FIELD_INDEX,GRAPH_VERTEX_FIELD_GRAPH,GRAPH_VERTEX_FIELD_CLASS),
			ENTITY_INDEX(IDX_GRAPH_VERTEX_BY_GRAPH_BY_VERTICE_ID , EntityIndex.TYPE_SIMPLE_MULTI_FIELD_INDEX, GRAPH_VERTEX_FIELD_GRAPH,GRAPH_VERTEX_FIELD_ID)
		);
		DEFINE_ENTITY_INDICES
		(
			GRAPH_DIRECTED_EDGE_ENTITY,
			ENTITY_INDEX(IDX_GRAPH_DIRECTED_EDGE_BY_ORIGIN_BY_DESTINATION, EntityIndex.TYPE_SIMPLE_MULTI_FIELD_INDEX,GRAPH_DIRECTED_EDGE_FIELD_ORIGIN,GRAPH_DIRECTED_EDGE_FIELD_DESTINATION),
			ENTITY_INDEX(IDX_GRAPH_DIRECTED_EDGE_BY_DESTINATION_BY_ORIGIN, EntityIndex.TYPE_SIMPLE_SINGLE_FIELD_INDEX,GRAPH_DIRECTED_EDGE_FIELD_DESTINATION,GRAPH_DIRECTED_EDGE_FIELD_ORIGIN),
			ENTITY_INDEX(IDX_GRAPH_EDGE_BY_GRAPH, EntityIndex.TYPE_SIMPLE_SINGLE_FIELD_INDEX, GRAPH_EDGE_FIELD_GRAPH)
		);
		DEFINE_ENTITY_INDICES
		(
			GRAPH_UNDIRECTED_EDGE_ENTITY,
			ENTITY_INDEX(IDX_GRAPH_EDGE_BY_GRAPH, EntityIndex.TYPE_SIMPLE_SINGLE_FIELD_INDEX, GRAPH_EDGE_FIELD_GRAPH),
			ENTITY_INDEX(IDX_GRAPH_UNDIRECTED_EDGE_BY_VERTICES, EntityIndex.TYPE_ARRAY_MEMBERSHIP_INDEX, GRAPH_UNDIRECTED_EDGE_FIELD_VERTICES)
		);
	}
